...
<input type="text" id="myInput" name="search" placeholder="Search By Patient name.." title="Type in a name" value="<?php echo @$_POST['search']; ?>">
...
if(isset($_POST['search']) && $_POST['search']!=''){
	$add_query = " and `fullName` like '%".trim($_POST['search'])."%'";
}
$sql=mysqli_query($con,"select * from users where 1 $add_query");
$cnt=1;
