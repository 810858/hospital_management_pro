...
$sql=mysqli_query($con,"insert into doctors(`specilization`, `doctorName`, `contactno`, `docEmail`, `emdocmobileno`, `docsalary`,`fb_url`,`twitter_url`,`ln_url`,`docpic`) values('$docspecialization','$docname','$docmobileno','$docemail','$emdocmobileno','$docsalary','$fb_url','$twitter_url','$ln_url','$docpic')");
if($sql)
{
...
<div class="form-group">														
	<label for="doctorname">
		Doctor Mobile No
					...
					<input type="text" maxlength="10" name="docmobileno" class="form-control"  placeholder="Enter Doctor Name">
														</div>
	...
	<label for="doctorname">
		Doctor Emergency Contact No
					...
					<input type="text" maxlength="10" name="emdocmobileno" class="form-control"  placeholder="Enter Doctor Emergency Contact No">
														</div>
...
<div class="form-group">
					...
					<input type="text" name="docsalary" class="form-control"  placeholder="Monthly Salary">
														</div>
<div class="form-group">
<label for="fess">
																 Facebook URL
